  ...
  return (
    <>
      <ResponsiveDialogDrawer placement="from-bottom" open={!!reward} onClose={onClose}>
        {({ close: closeDialog }) => (
          <Card
            className="p-8 mobile:p-4 rounded-3xl mobile:rounded-lg w-[min(698px,90vw)] max-h-[80vh] overflow-auto mobile:w-full border-1.5 border-[rgba(171,196,255,0.2)] bg-cyberpunk-card-bg shadow-cyberpunk-card"
            size="lg"
          >
            ...
            <div className="bg-[rgba(171,196,255,0.08)] text-secondary-title text-sm p-3 mb-5 rounded-xl">
              ...
              farming period. Any action that will decrease the reward rate can only be done within 72 hours of current
              farm end time, and the period must be extended by at least 7 days.
            </div>
